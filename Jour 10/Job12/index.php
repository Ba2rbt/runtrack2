...
<body>
    ...
    try {
        ...
        if ($resultat->num_rows > 0) {
            ...
            echo '<div class="success">Nombre total d\'étudiants nés entre 1998 et 2018 : ' . $resultat->num_rows . '</div>';
        } else {
            echo '<div class="error">Aucun étudiant né entre 1998 et 2018 trouvé dans la base de données.</div>';
        }
