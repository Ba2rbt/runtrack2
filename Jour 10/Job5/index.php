...
<body>
    ...
    try {
        ...
        $requete = "SELECT * FROM etudiants WHERE DATEDIFF(CURDATE(), naissance) / 365.25 < 18";
        ...
        if ($resultat->num_rows > 0) {
            ...
            echo '<div class="success">Nombre total d\'étudiants de moins de 18 ans : ' . $resultat->num_rows . '</div>';
        } else {
            echo '<div class="error">Aucun étudiant de moins de 18 ans trouvé dans la base de données.</div>';
        }
